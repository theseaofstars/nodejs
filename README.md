Node.js sample app on cetc-skyark!
-----------------
...
One option is to use the Docker all-in-one launch as described in the [cetc-skyark Origin project](https://github.com/cetc-skyark/origin).
...
Now let's pull in the app source code from [GitHub repo](https://github.com/cetc-skyark/nodejs-ex) (fork if you like).

#### create ####

        $ oc new-app https://github.com/cetc-skyark/nodejs-ex -l name=myapp
...
alt="cetc-skyark 3: Node.js Sample" width="240" height="180" border="10" /></a>
